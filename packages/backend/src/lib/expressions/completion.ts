import type { DescriptionPair } from "./completion/descriptionDictionary.ts";
import { type Dictionary, isDictionary } from "./data/dictionary.ts";
import type { ExpressionData } from "./data/expressiondata.ts";
import { Evaluator } from "./evaluator.ts";
import type { FunctionDefinition, FunctionInfo } from "./funcs/info.ts";
import { wellKnownFunctions } from "./funcs.ts";
import { Lexer, type Token, TokenType } from "./lexer.ts";
